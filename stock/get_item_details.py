...
def get_price_list_rate(args, item_doc, out):
	...
	if meta.get_field("currency") or args.get('currency'):
		...
		last_cust_price = frappe.db.get_value("Sales Order Item", {"item_code": args.item_code, "customer_price":args.customer}, "rate")
		xsub_unit = frappe.db.get_value("Item", {"item_code": args.item_code}, "sub_unit")
