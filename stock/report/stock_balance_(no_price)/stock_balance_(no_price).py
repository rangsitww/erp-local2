...
def get_columns(filters):
	...
	columns = [
		...
		{"label": _("คงเหลือ"), "fieldname": "qty_full", "fieldtype": "Float", "width": 80},
		{"label": _("เศษ"), "fieldname": "qty_sub", "fieldtype": "Float", "width": 80},
		{"label": _("Bคงเหลือย่อย"), "fieldname": "bal_qty", "fieldtype": "Float", "width": 100, "convertible": "qty"},
...
def get_item_warehouse_map(filters, sle):
	...
	for d in sle:
		...
		xcv = frappe.db.get_value('UOM Conversion Detail', {'parent': d.item_code, 'conversion_factor': ['>', 1]}, ['conversion_factor'])
